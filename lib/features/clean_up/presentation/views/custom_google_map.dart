...
class _CustomGoogleMapState extends State<CustomGoogleMap> {
  ...
  void initState() {
    LatLng initialLocation = widget.isShowCompany
        ? const LatLng(30.78697791026139, 30.992115169171413)
    ...
    widget.isShowCompany
        ? markers.add(
            const Marker(
              ...
              position: LatLng(30.78697791026139, 30.992115169171413),
            ),
          )
        : markers = {};
              ...
              : Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      initMarkers();
                      await BlocProvider.of<CleanUpCubit>(context)
                          .sendUserLocation(
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child:
                              SvgPicture.asset('assets/svg/set_location.svg')),
                    ),
                  ),
                ),
          Positioned(
